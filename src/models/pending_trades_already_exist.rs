...
pub struct PendingTradesAlreadyExist {
    #[serde(rename = "name")]
    pub name: Name,
...
impl PendingTradesAlreadyExist {
    pub fn new(name: Name, message: String, data: models::PendingTradesAlreadyExistData) -> PendingTradesAlreadyExist {
