...
pub struct GaslessGetPrice400Response {
    #[serde(rename = "name")]
    pub name: Name,
...
impl GaslessGetPrice400Response {
    pub fn new(name: Name, message: String, data: models::BuyTokenNotAuthorizedForTradeData) -> GaslessGetPrice400Response {
