...
pub struct SwapPermit2GetPrice500Response {
    #[serde(rename = "name")]
    pub name: Name,
...
impl SwapPermit2GetPrice500Response {
    pub fn new(name: Name, message: String, data: models::BuyTokenNotAuthorizedForTradeData) -> SwapPermit2GetPrice500Response {
