...
pub struct SwapPermit2GetPrice400Response {
    #[serde(rename = "name")]
    pub name: Name,
...
impl SwapPermit2GetPrice400Response {
    pub fn new(name: Name, message: String, data: models::BuyTokenNotAuthorizedForTradeData) -> SwapPermit2GetPrice400Response {
...
pub enum Name {
    #[serde(rename = "TOKEN_NOT_SUPPORTED")]
    TokenNotSupported,
}
