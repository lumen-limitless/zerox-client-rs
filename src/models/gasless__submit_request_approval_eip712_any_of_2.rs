...
pub struct GaslessSubmitRequestApprovalEip712AnyOf2 {
    #[serde(rename = "types")]
...
impl GaslessSubmitRequestApprovalEip712AnyOf2 {
    pub fn new(types: models::GaslessSubmitRequestApprovalEip712AnyOf2Types, domain: models::SwapPermit2GetQuote200ResponseAnyOfPermit2Eip712Domain, message: models::GaslessSubmitRequestApprovalEip712AnyOf2Message, primary_type: PrimaryType) -> GaslessSubmitRequestApprovalEip712AnyOf2 {
