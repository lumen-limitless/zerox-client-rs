...
pub struct GaslessGetQuote400Response {
    #[serde(rename = "name")]
    pub name: Name,
...
impl GaslessGetQuote400Response {
    pub fn new(name: Name, message: String, data: models::BuyTokenNotAuthorizedForTradeData) -> GaslessGetQuote400Response {
